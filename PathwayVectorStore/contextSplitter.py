...
class ContextualRetrievalSplitter(pw.UDF):
    ...
    def __wrapped__(self, txt: str, **kwargs) -> list[tuple[str, dict]]:
        ...
        with ThreadPoolExecutor() as executor:
            ...
            # for future in tqdm(as_completed(future_to_page), total=len(pages), desc="Chunking and getting context"):
            #     try:
            ...
            chunks_temp = [future.result() for future in tqdm(as_completed(future_to_page), 
